package com.xsili.mybatis.plugin.page;
...
import com.xsili.mybatis.plugin.page.exception.PluginPropertyUndefinedException;
import com.xsili.mybatis.plugin.page.model.DBTypeEnum;
import com.xsili.mybatis.plugin.page.model.QueryParam;
import com.xsili.mybatis.plugin.page.util.GenMysqlCountUtil;
import com.xsili.mybatis.plugin.page.util.ReflectUtil;
...
public class PagePlugin implements Interceptor {
    ...
    public Object intercept(Invocation ivk) throws Throwable {
        ...
        if (!(parameterObject instanceof QueryParam)) {
            // 如查询条件封装类不继承QueryParam则不分页  modify by yechao 20170319
        ...
        if (countSql != null) {
            ...
            try {
                ...
                queryParam.setTotalCount(count);
            } finally {
                rs.close();
                countStmt.close();
            }
